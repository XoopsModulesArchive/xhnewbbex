...
Date : 03/01/2004
Update : 01/03/20055 - 16/04/2005 - 27/07/2205 - 21/12/2005
Type : Extension et modification du module forum
Xoops version used : 2.0.5.1 et 2.0.9.2
Crédits : This module is based on the original xhnewbb 1 module so all the
...
- Forums Statistics
How to migrate from xhnewbb to xhnewbbex :
It's easy !
Some new fields were added to the tables compare to the original
version.
So you just have to create an sql export of your xhnewbb forums and
