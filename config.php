<?php
// $Id: config.php,v 1.3 2006/03/28 03:58:44 mikhail Exp $
// ------------------------------------------------------------------------ //
...
$bbUrl['root'] = XOOPS_URL . '/modules/xhnewbbex/';
...
$temptime = $HTTP_COOKIE_VARS['NewBBLastVisitTemp'] ?? $HTTP_COOKIE_VARS['NewBBLastVisit'] ?? time();
// set cookie.
