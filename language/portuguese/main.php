<?php
// $Id: main.php,v 1.4 2006/03/28 03:58:50 mikhail Exp $
//%%%%%% Module Name phpBB %%%%%
//functions.php
...
define('_MDEX_POSTEDON', 'Postado sobre: ');
...
define('_MDEX_USERNAME', 'Utilizador');
...
define('_MDEX_PRIVATE', 'Este é um fórum <b>Privado</b>. <br>Somente os visitantes com acesso especial podem criar tópicos e respostas novas neste este fórum'); define('_MD_REGCANPOST', 'All <b>Registered</b> users can post new topics and replies to this forum');
...
define('_MDEX_USERNOEXIST', 'Esse visitante não existe.Por favor volte mas tarde e procure novamente.');
...
define('_MDEX_VIEWTHETOPIC', 'Mostrar tópico');
