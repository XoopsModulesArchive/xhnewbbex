<?php
// $Id: modinfo.php,v 1.2 2006/03/28 03:58:50 mikhail Exp $
// Module Info
...
define('_MI_NEWBBEX_SHOWMSGDESC', 'Quando configurado para não, os visitantes não poderão ver fóruns e mensagens que eles não tem acesso');
