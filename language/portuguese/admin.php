<?php
// $Id: admin.php,v 1.2 2006/03/28 03:58:50 mikhail Exp $
//%%%%%% File Name index.php %%%%%
...
define('_MDEX_A_REGISTERUSERONLY', 'Somente visitantes registrados');
...
define('_MDEX_A_VTFYJC', 'Mostrar o fórum criado.');
...
define('_MDEX_A_UWA', 'Utilizadors Com Acesso:');
define('_MDEX_A_UWOA', 'Utilizadors Sem Acesso:');
define('_MDEX_A_ADDUSERS', 'Adicionar Utilizadors -->');
define('_MDEX_A_CLEARALLUSERS', 'Limpar todos os visitantes');
define('_MDEX_A_REVOKEPOSTING', 'remover mensagens');
define('_MDEX_A_GRANTPOSTING', 'garantir mensagens');
// Ajouts Hervé
define('_MDEX_A_SHOWNAME', 'Substitua o nome de visitante pelo verdadeiro nome');
